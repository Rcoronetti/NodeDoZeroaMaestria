...
const server = http.createServer((req, res) => {
    ...
    if (!name) {
        ...
        //basicamente é: o usuário pode ficar digitanado seu nome quantas vezes quiser que fico mandando seu nome pra /, o sistema nao para, mas salva somente o ultimo.
        //Mas observe que writefile substitui tudo que está no arquivo. por isso so guarda um nome.
